...
public class AvcEncoder
{
 ...
 //   private Sender UdpSender;
    ...
    public AvcEncoder(int width, int height, int framerate, int bitrate, Client client) {
    ...
    private void createSocketStream(){
        try {
            ...
            if(os!=null){
                ...
                Log.e(TAG,"SocketStream created");
            }
        } catch (Exception e){
            e.printStackTrace();
        }
...
//            }
                        ...
                        try {
                            ...
                            while (outputBufferIndex >= 0) {
                                ...
                                if(bufferInfo.flags == BUFFER_FLAG_CODEC_CONFIG){
                                 ...
                                 //   UdpSender.send(keyframe);
                                    outputStream.write(keyframe, 0, keyframe.length);
                                }else{
                                    //写到文件中
                                  //  UdpSender.send(outData);
    ...
    public boolean setMode(boolean stream){
       return this.streamMode = stream;
    }
}